...
class Driver extends Homey.Driver {
  ...
  async onInit() {
    ...
    const cardActionSetfanspeed = this.homey.flow.getActionCard('intesis-wifil-set-fanspeed');
    cardActionSetfanspeed.registerRunListener(async (args) => {
      args.device.setfanspeed(args.speed);
    })
    const cardActionSetmode = this.homey.flow.getActionCard('intesis-wifil-set-mode');
